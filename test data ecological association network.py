...
#im = Infomap(directed=True, two_level=True, markov_time = 0.5, num_trials=20, teleportation_probability=0.15)
im=Infomap()
...
color_map = {cluster: mcolors.to_hex(mcolors.TABLEAU_COLORS[colors[i % len(colors)]]) for i, cluster in enumerate(unique_clusters)}
